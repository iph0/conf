...
configuration loader. Configuration processor in conf module supports several
processing directives: $include, $ref, $underlay and $overlay. See more information
about directive below.
